...
# jhaney pag install ug pip install PyQt5-QtChart, ako ra gi comment kay sa ako amkuaywan ko mag install maguba nya
# from PyQt5.QtChart import QChartView, QBarSeries, QBarSet, QChart, QBarCategoryAxis, QValueAxis, QAbstractBarSeries
...
class DashboardModel:
    ...
    def _execute_single_value_query(self, query: str, description: str, params: tuple = None):
        ...
        try:
            ...
            # If it's a count, convert to int
            ...
            # Return appropriate default based on expected type (int for counts, float for sums)
            if "count" in description.lower() or "orders" in description.lower():
                return 0
            return 0.0 
